  ...
  <div class="col-md-9">
    ...
    <div class="row" style="margin-top: 10px;">
      <?= $this->Html->link(__('Relatório da forma mais utilizada pelos usuários para chegar até osprodutos de interesse'), ['controller' => 'tracking', 'action' => 'relatorio3'],['class' => 'btn btn-default']) ?>
    </div>
