    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['controller' => 'Favoritos', 'action' => 'view', $favoritos->user_id]) ?>
                    <?= $this->Html->link(__('Edit'), ['controller' => 'Favoritos', 'action' => 'edit', $favoritos->user_id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['controller' => 'Favoritos', 'action' => 'delete', $favoritos->user_id], ['confirm' => __('Are you sure you want to delete # {0}?', $favoritos->user_id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </table>
